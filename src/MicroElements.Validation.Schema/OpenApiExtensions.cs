...
namespace MicroElements.Swashbuckle.FluentValidation
{
    ...
    public static class OpenApiExtensions
    {
        ...
        /// </summary>
        internal static void SetNotNullableIfMinLengthGreaterThenZero(this IProperty schemaProperty)
        {
        ...
        internal static void SetNewMax(this IProperty schemaProperty, Expression<Func<OpenApiSchema, int?>> prop, int? newValue)
        {
        ...
        internal static void SetNewMax(this IProperty schemaProperty, Expression<Func<OpenApiSchema, decimal?>> prop, decimal? newValue)
        {
            if (newValue.HasValue)
            {
                var current = prop.Compile()(schemaProperty);
        ...
        internal static void SetNewMin(this IProperty schemaProperty, Expression<Func<OpenApiSchema, int?>> prop, int? newValue, bool setNotNullableIfMinLengthGreaterThenZero = true)
        {
            if (newValue.HasValue)
            {
                var current = prop.Compile()(schemaProperty);
        ...
        internal static void SetNewMin(this IProperty schemaProperty, Expression<Func<OpenApiSchema, decimal?>> prop, decimal? newValue, bool setNotNullableIfMinLengthGreaterThenZero = true)
        {
            if (newValue.HasValue)
            {
                var current = prop.Compile()(schemaProperty);
